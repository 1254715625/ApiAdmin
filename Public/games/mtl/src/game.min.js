		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://game.3gjj.cn";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://game.3gjj.cn";
y.url = function() {
	return "http://game.3gjj.cn?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://game.3gjj.cn/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://game.3gjj.cn"
			}, this);
